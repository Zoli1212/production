...
import io.agileintelligence.fullstackhateoas_backend.assambler.CapabilityResourceAssembler;
...
public class CapabilityController {
    ...
    public Resources<Resource<Capability>> getAllCapabilities(){
        ...
        return new Resources<>(capabilityService.getAllCapabilities().stream().map(capability -> assembler.toResource(capability)).collect(Collectors.toList()),
